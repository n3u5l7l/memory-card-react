...
export default function MainContent(props) {
  ...
  useEffect(() => {
    if (props.currLevel-1 > Number(localStorage.getItem("bestScore"))) {
  ...
  return (
    <div className="mainContent">
      ...
      <Cards
        currLevelHandler={props.currLevelHandler}
        handleGameOver={props.gameOver}
        loadHandler={props.loadHandler}
        cardInfos={props.cardInfos}
        totalCards={props.currLevel + 4}
      />
    </div>
  );
}
